...
contract ZKBoys is ERC721, Ownable {
    ...
    // maximum token supply for whitelist
    uint256 public constant MAX_SUPPLY_FOR_WL = 400;

    // maximum mint amount per whitelisted address
    uint256 public constant MAX_AMOUNT_PER_WL = 5;
    // maximum mint amount per address in public sale
    uint256 public constant MAX_AMOUNT_PER_PUBLIC = 20;
